...
tf.app.flags.DEFINE_integer(
    'input_channel', 7,
    'channel number of input, 1 refer to ccmpred, other refer to other feature(ss3)')

##########################
#                  restore
##########################
tf.app.flags.DEFINE_string(
    'train_dir', './output/new_train_ss3/',
    #'train_dir', './output/new_train_ss3_nomask/',
    #'train_dir', './output/new_train_ss3_test_istraining/',
...
tf.app.flags.DEFINE_string(
    'dataset_split_name', 'train_ss3',
    'The name of the train/test/val split.')

tf.app.flags.DEFINE_string(
    'dataset_dir', 'data/NewTrain/',
...
tf.app.flags.DEFINE_integer(
    'max_iters', 100000, #default = 300000
    'max iterations')
